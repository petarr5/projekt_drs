...
print("\nDemo finished.")
ubuntu@ip-172-31-27-56:/mnt/shared/projekt$ cat start.sh
#!/bin/bash

echo "Starting replicas and coordinator..."

# Replica nodes
uvicorn replica:app --port 8001 &
uvicorn replica:app --port 8002 &
uvicorn replica:app --port 8003 &

sleep 2

# Coordinator
uvicorn coordinator:app --port 8004 &

echo "All services started"
echo "Coordinator → http://127.0.0.1:8004/docs"